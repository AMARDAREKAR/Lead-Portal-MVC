...
${message}
	<form:form name="addEmployeeForm" onsubmit="return validateEmployeeForm()"
		action="bdm.uploadnewuser" modelAttribute="newuserbybdm" method="POST">
		<table>
			<tbody>
				<tr>
					<td>First Name</td>
				...
				<tr>
					...
					<td>: <form:select path="designation">
							...
							<form:option value="TEAM LEADER" label="TEAM LEADER" />
						</form:select></td>
	...
	<table border="2" width="70%" cellpadding="2">
		...
		<c:forEach var="employee" items="${employeeList}">
			...
			<!-- construct an "update" link with employeeId id -->
			<c:url var="updateLink" value="/bdm.updateEmployee">
